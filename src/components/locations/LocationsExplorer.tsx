...
export default function LocationsExplorer() {
  ...
  return (
    <div className="flex flex-col gap-6 lg:grid lg:h-[clamp(560px,82vh,1040px)] lg:grid-cols-[minmax(0,545px)_minmax(0,1fr)] lg:grid-rows-[auto_minmax(0,1fr)] lg:gap-x-16 lg:gap-y-8 lg:[grid-template-areas:'search_map''list_map']">
      ...
      <div className="order-2 h-[340px] overflow-hidden rounded-2xl border border-[#1e1e1e] sm:h-[420px] lg:order-none lg:h-full lg:[grid-area:map]">
