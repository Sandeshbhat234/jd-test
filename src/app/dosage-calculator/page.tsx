...
export const metadata: Metadata = {
  title: "Dosage Calculator — JD's Jungle",
  description:
    "Our dosage calculator is on its way. In the meantime, explore our hand-selected menu of premium cannabis products.",
};
      ...
      >
        <div className="flex flex-col items-center gap-[clamp(10px,1.4vw,16px)]">
          ...
          <p className="max-w-[1089px] font-cy text-[clamp(16px,3vw,32px)] leading-[1.5] text-[#1e1e1e]">
            Our dosage calculator is on its way. In the meantime, explore our
            hand-selected menu of premium cannabis products.
          </p>
        </div>
